...
MACRO(ILLYRIAN_FIND_PYTHON)
	...
	ELSEIF(NOT Python3_VERSION_MAJOR)
		...
		SET(Python_FIND_STRATEGY LOCATION)	#1748
		SET(Python_FIND_VIRTUALENV FIRST)	#1748
...
FUNCTION(ILLYRIAN_TARGET_OPTIONS NAME)
	...
	SET(ILLYRIAN_LINK_FLAGS "-Wl,--disable-new-dtags -Wl,-z,defs") # #1775
	...
	SET_TARGET_PROPERTIES(${NAME} PROPERTIES
		LINK_FLAGS 		"${ILLYRIAN_LINK_FLAGS}"
