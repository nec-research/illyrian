...
MACRO(ILLYRIAN_FIND_PYTHON)
	...
	ELSEIF(NOT Python3_VERSION_MAJOR)
		...
		EXECUTE_PROCESS(COMMAND ${Python3_EXECUTABLE} -m site OUTPUT_VARIABLE Python3_SITE OUTPUT_STRIP_TRAILING_WHITESPACE)
		SET(Python3_USERSITE_ENABLED Off)
		STRING(REGEX MATCH "ENABLE_USER_SITE:[ ]*True" Python3_USER_SITE_ENABLED ${Python3_SITE})
